        ...
        <div style={{ width: '90%', borderRadius: '10px', backgroundColor: '#fff' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3% 5%' }}>
                <div style={{ display: 'flex', gap: '20px' }}>
                    <div style={{ height: '30px', width: '30px', }} ><img style={{ height: '100%', width: '100%' }} src={save} alt="" /></div>
                    <div style={{ height: '30px', width: '30px', }} ><img style={{ height: '100%', width: '100%' }} src={send} alt="" /></div>
                </div>
                <button style={{ width: '120px', height: '45px', borderRadius: '10px', backgroundColor: '#FECF34', outline: 'none', border: 'none' }}>Apply Now</button>
            </div>
        </div>
    )
}