...
function Jobs() {
    ...
    const data = [ { task: "Update profile", tag: "To find you" },{ task: "Update profile", tag: "To find you" },{ task: "Update profile", tag: "To find you" }, { task: "Update profile", tag: "To find you" }, { task: "Update profile", tag: "To find you" }, { task: "Update profile", tag: "To find you" }, { task: "Update profile", tag: "To find you" }, { task: "Update profile", tag: "To find you" }]
    return (
        <div>
            ...
            <div className="main-jobs">
                ...
                <div className="w-30" style={{ display: 'flex', flexDirection: 'column', gap: '50px', alignItems: 'center', }} >
                    <div className="" style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', color: '#fff' }}>
                        <img src={profile} style={{ marginTop: '20px', height: "121px", width: '117px' }} alt="" />
                    ...
                    <div style={{ width: '100%', height: '100px', borderRadius: '18px', backgroundColor: '#fff', padding: '20px 30px' }}>
                        ...
                        <div style={{ height: '3px', width: '100%', background: '#D9D9D9', marginTop: '20px' }}>
                            <div style={{ height: '3px', width: '50%', background: '#9AD8A0' }}></div>
                        </div>
                    </div>

                    <div className='saved-jobs-cont' style={{ width: '100%', borderRadius: '18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '20px', padding: '10px',position:"sticky",top:"15px",height:'95vh',overflow:'auto' }}>
                ...
                <div className="w-30" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>

                    <div className='notification-main-cont' style={{ padding: '20px 30px' }}>
                    ...
                    <div className='todo-main-cont' style={{position:"sticky",top:"15px", width: '100%', height: 'auto', maxHeight: 'max-content', padding: '20px 30px',height:'95vh',overflow:'auto' }}>
      ...
      <JobModal closeModal={() => setIsOpen(false)} isOpen={modalIsOpen} />
        <div style={{ width: '100%', height: '110px', borderRadius: '20px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)', padding: '10px 15px', display: 'flex' }}>
            ...
            <div style={{ height: "100%", width: '50%', display: 'flex', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'end' }}>
                ...
                <h4 style={{ color: '#3B6FB1',fontSize:"14px",cursor:"pointer" }} onClick={() => setIsOpen(true)}>VIEW DETAILS</h4>
            </div>
        </div>
        </>
    )
      ...
      <JobModal closeModal={() => setIsOpen(false)} isOpen={modalIsOpen} />
        ...
        <div style={{ width: '90%', borderRadius: '10px', backgroundColor: '#fff' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3% 5%' }}>
                ...
                <button style={{ width: '120px', height: '45px', borderRadius: '10px', backgroundColor: '#FECF34', outline: 'none', border: 'none' }} onClick={() => setIsOpen(true)}>Apply Now</button>
